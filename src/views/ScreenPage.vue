    ...
    <div class="screen-container">
        ...
        <img src="static/img/logo1.png" alt="" />
            ...
            <div class="title-right">
                <span class="datetime">2021-09-29 18:00:00</span>
            </div>
        </header>
                            ...
                            <div class="hn_list_tree">
                                <ul>
                                    <li>
                                        ...
                                        <span class="list-c">
                                            <img
                                                src="../../public/static/img/icon_hn.png"
                                                alt=""
                                            />
                                        </span>
                                        <div class="list-r">
                                    ...
                                    <li>
                                        ...
                                        <span class="list-c">
                                            <img
                                                src="../../public/static/img/icon_shui.png"
                                                alt=""
                                            />
                                        </span>
                                        <div class="list-r">
                                    ...
                                    <li>
                                        ...
                                        <span class="list-c">
                                            <img
                                                src="../../public/static/img/icon_dian.png"
                                                alt=""
                                            />
                                        </span>
                                        <div class="list-r">
                ...
                <div id="middle-top">
                    <div class="map-allter">
                        <div class="map-allter-t">
                            <span>
                                <img
                                    src="../../public/static/img/icon1.png"
                                    alt=""
                                />
                                风险预警
                            </span>
                        ...
                        <div class="map-allter-b">
                            <span>
                                <img
                                    src="../../public/static/img/dian.png"
                                    alt=""
                                />
                            </span>
                        </div>
                            ...
                            <div class="sshn_list_tree">
                                ...
                                <ul>
                                    <li>
                                        <span class="list-c">
                                            <img
                                                src="../../public/static/img/icon_y.png"
                                                alt=""
                                            />
                                        </span>
                                        <div class="list-r">
                                            <p class="num-t">
                                                <span>1568.08</span> kwh
                                            </p>
                                            <p class="num-b">
                                                <span
                                                    >同比
                                    ...
                                    <li>
                                        <span class="list-c">
                                            <img
                                                src="../../public/static/img/icon_m.png"
                                                alt=""
                                            />
                                        </span>
                                        <div class="list-r">
                                    ...
                                    <li>
                                        <span class="list-c">
                                            <img
                                                src="../../public/static/img/icon_d.png"
                                                alt=""
                                            />
                                        </span>
                                        <div class="list-r">
                            ...
                            <div class="qx_list_tree">
                                <ul>
                                    ...
                                    <li>
                                        <span class="list-l">
                                            <img
                                                src="../../public/static/img/icon_tq.png"
                                                alt=""
                                            />
                                        </span>
...
.screen-body {
    ...
    .screen-middle {
        ...
        #middle-top {
            ...
            .map-allter {
                ...
                .map-allter-t {
                    width: 193px;
                    height: 103px;
                    background: url(../../public/static/img/tip_box.png)
                        no-repeat;
                    background-size: 100% 100%;
                    display: flex;
        ...
        #middle-bottom {
            ...
            .box-con {
                height: 269px;
                background: url("../../public/static/img/box_center.png")
                    no-repeat;
                background-size: 100% 100%;
                .con {
                    height: 253px;
